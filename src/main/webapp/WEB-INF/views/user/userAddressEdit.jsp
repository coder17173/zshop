...
<div class="container-fluid">
    ...
    <div class="row2">
        <div class="col-md-6 col-md-offset-3">
            <form:form id="inputForm" role="form" action="${pageContext.request.contextPath}/user/userAddress/doEdit"
                       method="post" class="form-horizontal" enctype="multipart/form-data">
                <div class="form-group">
                    <input type="hidden" name="id" value="${userAddress.id}"/>
                    <label class="col-sm-2 control-label">收件人</label>
                    <div class="col-sm-10">
                        <input minlength="6" required class="form-control" value="${userAddress.name}" type="text"
                               id="name" name="name"/>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input required class="form-control" type="text" value="${userAddress.zipcode}" id="zipcode"
                               name="zipcode"/>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input class="form-control" type="text" id="phone" value="${userAddress.phone}" name="phone"/>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 control-label">地址</label>
                    <div class="col-sm-10">
                        <input class="form-control" required type="text" value="${userAddress.address}" id="address"
                               name="address"/>
                    </div>
                </div>
